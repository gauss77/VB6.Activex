...
Private Const m_def_BackColor   As Long = &H8000000F 'vbButtonFace
Private Const m_def_BackColorB  As Long = &H80000010 'vbButtonShadow
Private Const m_def_ForeColor   As Long = &H80000012  'vbButtonText
Private Const m_def_CaptionBackColor As Long = &H8000000F 'vbButtonFace
...
Private Sub Draw()
    ...
    If meGradStyle <> gsNone And pic = 0 Then
        Call DrawGradiente
    ElseIf pic <> 0 Then
        UserControl.Picture = pic
    End If
...
'WARNING! DO NOT REMOVE OR MODIFY THE FOLLOWING COMMENTED LINES!
'MappingInfo=lblCaption,lblCaption,-1,BackStyle
Public Property Get CaptionBackStyle() As Integer
Attribute CaptionBackStyle.VB_Description = "Returns/sets the border style for an object."
    CaptionBackStyle = lblCaption.BackStyle
End Property

Public Property Let CaptionBackStyle(ByVal New_CaptionBackStyle As Integer)
    lblCaption.BackStyle() = New_CaptionBackStyle
