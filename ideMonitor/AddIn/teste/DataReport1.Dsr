...
Private Sub DataReport_Initialize()
    Call AddInMonitor.Gravar.Log("Objeto", "Project1.DataReport1.DataReport_Initialize")

End Sub

Private Sub DataReport_Terminate()
    Call AddInMonitor.Gravar.Log("Objeto", "Project1.DataReport1.DataReport_Terminate")
