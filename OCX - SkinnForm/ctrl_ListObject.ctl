...
Private Sub img_MoveDown_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
  mbMouseDown = True
  TimerListDown.Enabled = True
End Sub

Private Sub img_MoveDown_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
  mbMouseDown = False
End Sub
